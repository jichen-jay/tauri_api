<script>
  ...
  let innerPosition = $state(new PhysicalPosition(x, y))
  let outerPosition = $state(new PhysicalPosition(x, y))
  let innerSize = $state(new PhysicalSize(width, height))
  let outerSize = $state(new PhysicalSize(width, height))
  ...
  let effectR = $state(), effectG = $state(), effectB = $state(), effectA = $state()
...
<div class="flex flex-col children:grow gap-8 mb-4">
  ...
  >
    ...
    <div class="grid gap-1">
      ...
      <form class="flex gap-2" onsubmit={preventDefault(createWebviewWindow)}>
        <input
          class="input"
          type="text"
  ...
  {#if webviewMap[selectedWebview]}
    <div class="flex flex-wrap items-center gap-4">
      <div class="grid gap-1 grow">
        ...
        <form class="flex gap-2" onsubmit={preventDefault(changeIcon)}>
          <input
      ...
      <div class="grid gap-1 grow">
        ...
        <form class="flex gap-2" onsubmit={preventDefault(setTitle)}>
